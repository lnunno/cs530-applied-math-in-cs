...
$$
\norm{\text{supp } z}^2 \cdot \norm{\text{supp } \hat{z}}^2 \geq N
$$
...
$(a_1 + i b_1) \times (a_2 + i b_2) $
$= (a_1 \times a_2 - b_1 \times b_2) + i (a_1 \times b_2 + a_2 \times b_1)$

$z^{-1} = \frac{\conj{z}}{a^2+b^2}$
...
$$
e^{i\theta} 
\text{ where } \theta = \frac{2k\pi}{n}, k = 0,1,\dots,n-1
$$
...
$\inp{u+v}{w} = \inp{u}{w} + \inp{u}{v}$

$\inp{\alpha u}{v} = \alpha \inp{u}{v}$

Conjugate symmetry
$\inp{u}{v} = \conj{\inp{u}{v}}$

Cauchy-Shwarz inequality
$\conj{\inp{u}{v}} \leq \norm{u} \norm{v}$

$\inp{u}{u} \geq 0 $ and $\inp{u}{u} = 0 \iff u = \mathbf{0}$
...
$$
\sqrt{N} \cdot F_m = \frac{F_m}{\norm{F_m}} = \frac{F_m}{\frac{1}{\sqrt{N}}}
$$

The Fourier Basis for $\Complex^4$ is:
$$
\begin{bmatrix}
1 & 1  & 1  & 1 \\
1 & -i & -1 & i \\
